...
df = pd.read_csv('df_forecast_1.csv') #Dataset untuk forecasting (Gabungan Dataset Training & Testing)
forecast_default = pd.read_csv('forecast_default.csv') #Dataset untuk menunjukkan hasil forecast default
forecast_default['ds'] = pd.to_datetime(forecast_default['ds'],format = '%Y-%m-%d')
aov_low = pd.read_csv('aov_low.csv') #Dataset untuk column aov_kategorik_low -- untuk regressor prophet
aov_med = pd.read_csv('aov_med.csv') #Dataset untuk column aov_kategorik_med -- untuk regressor prophet
aov_med_high = pd.read_csv('aov_med_high.csv') #Dataset untuk column aov_kategorik_med_high -- untuk regressor prophet
aov_high = pd.read_csv('aov_high.csv') #Dataset untuk column aov_kategorik_high -- untuk regressor prophet
with open('metric.json') as json_file: #Json berisi metric hasil testing di pipeline
